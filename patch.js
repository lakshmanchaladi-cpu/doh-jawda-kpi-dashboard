...
const replacement =   async renderVault(container) {
    ...
    try {
      const res = await fetch(\/api/audit/vault-summary?facility_id=\\);
      ...
      Object.keys(byYear).sort((a,b) => b - a).forEach(year => {
        html += \<h4 class="mt-4 mb-3 fw-bold border-bottom pb-2 text-dark"><i class="bi bi-calendar4 text-primary me-2"></i>Year \</h4>\;
            ...
            <div class="col-12 col-md-6 col-xl-3">
              <div class="card shadow-sm border-0 h-100">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                  <h6 class="mb-0 fw-bold"><i class="bi bi-calendar3 me-2 text-primary"></i> \</h6>
                ...
                <div class="card-body px-3 py-4">
                  ...
                  <div class="d-flex justify-content-between text-muted" style="font-size: 0.75rem;">
                    <span>Rate: \%</span>
                    <span>Last Calc: <span id="calc-date-\-\">\</span></span>
                  </div>
                </div>
                <div class="card-footer bg-light p-2 d-flex justify-content-between gap-1">
                  <button class="btn btn-outline-secondary btn-sm flex-fill" onclick="DataManager.downloadExceptions(\, \)" title="Download Exceptions">
                    <i class="bi bi-download"></i> Exceptions
                  </button>
                  <button class="btn btn-primary btn-sm flex-fill fw-semibold" id="btn-calc-\-\" onclick="DataManager.calculateKpis(\, \)">
      ...
      container.innerHTML = \<div class="alert alert-danger">Error loading vault summary: \</div>\;
    }
  },;
