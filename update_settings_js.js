...
const oldHtml = `                  <div class="tab-pane fade p-4 text-center text-muted" id="map-dr" role="tabpanel">
                    <i class="bi bi-person-badge fs-1 mb-3"></i>
                    <h5>Auto-Categorized During Import</h5>
                    <p class="mb-0">We normalize DOH clinician codes automatically into standard JAWDA buckets (PC_Valid, PC_Paed, etc.) upon upload to keep the engine fast.</p>
                  </div>`;
...
console.log('Replaced HTML and added JS');
