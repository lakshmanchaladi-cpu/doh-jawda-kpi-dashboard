import{A as d}from"./main-DHmSEy9Y.js";function b(t,a){const e=t.closest("table"),s=e.querySelector("tbody"),n=Array.from(s.querySelectorAll("tr"));let c=t.dataset.dir||"asc";n.sort((i,r)=>{const l=i.cells[a].textContent.trim(),h=r.cells[a].textContent.trim();return c==="asc"?l.localeCompare(h,void 0,{numeric:!0}):h.localeCompare(l,void 0,{numeric:!0})}),t.dataset.dir=c==="asc"?"desc":"asc",n.forEach(i=>s.appendChild(i)),e.querySelectorAll("th span").forEach(i=>i.textContent="")}window.sortAuditTable=b;const m={state:{monthlyData:[],activeTab:"monthly",reconciliation:null,thiqaPage:1,thiqaPageSize:50},isLocked:!1,render(t){if(!d.state.facilityId){t.innerHTML='<div class="alert alert-warning"><i class="bi bi-exclamation-triangle"></i> Please select a facility first.</div>';return}t.innerHTML=`
